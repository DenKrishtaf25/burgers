...
class Landing extends React.Component {
    ...
    displayList = () => {
        const { display } = this.state //деструктурирование 
        ...
        return (
            <div className='restaurant_select'>
                <div className='restaurant_select_top'>
                    <div onClick={this.displayList} className='restaurant_select_header font-effect-outline'>{this.state.title ? this.state.title : 'Выбери ресторан'}</div>
